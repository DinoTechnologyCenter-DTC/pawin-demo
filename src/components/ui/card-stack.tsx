...
export function CardStack<T extends CardStackItem>({
  ...
  return (
    ...
    >
      ...
      {showDots ? (
        <div className="mt-6 flex items-center justify-center gap-3 relative z-50">
...
function DefaultFanCard({ item }: { item: CardStackItem; active: boolean }) {
  return (
    <div className="relative h-full w-full bg-slate-900 border border-slate-700/50 rounded-xl overflow-hidden shadow-2xl shadow-black/50">
      {/* image */}
