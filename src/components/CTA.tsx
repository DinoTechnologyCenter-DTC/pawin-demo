  ...
  return (
    <section className="py-20">
      <div className="container mx-auto px-6">
        <Animated>
          <div className="bg-gradient-to-r from-[#ffae1f] via-[#fe4f51] to-[#ffae1f] rounded-xl p-12 text-center text-white animate-gradient-pan">
            ...
            <button 
              ...
              className="bg-white text-[#fe4f51] font-semibold px-8 py-3 rounded-lg hover:bg-slate-100 transition-all duration-300 transform hover:scale-105">
              Join the Movement
            </button>
          </div>
        </Animated>
